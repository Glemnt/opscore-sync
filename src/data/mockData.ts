...
export const clients: Client[] = [
  {
    ...
    contractType: 'mrr', paymentDay: 10, healthColor: 'green' as const, changeLogs: [], chatNotes: [],
  },
  {
    ...
    contractType: 'tcv', paymentDay: 15, contractDurationMonths: 6, healthColor: 'red' as const, changeLogs: [], chatNotes: [],
  },
  {
    ...
    contractType: 'mrr', paymentDay: 5, healthColor: 'yellow' as const, changeLogs: [], chatNotes: [],
  },
  {
    ...
    contractType: 'mrr', paymentDay: 1, healthColor: 'green' as const, changeLogs: [], chatNotes: [],
  },
  {
    ...
    contractType: 'tcv', paymentDay: 20, contractDurationMonths: 3, healthColor: 'white' as const, changeLogs: [], chatNotes: [],
  },
  {
    ...
    contractType: 'mrr', paymentDay: 25, healthColor: 'red' as const, changeLogs: [], chatNotes: [],
  },
];
